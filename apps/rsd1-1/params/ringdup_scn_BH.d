...
#
#
 MyModuleId     MOD_RINGDUP_SCN_BH  # module id for this program
 InRing         WAVE_RING           # transport ring to use for input
 OutRing        EXPPT_RING_BH       # transport ring to use for output
...
#              Installation       Module       Message Type
 ...
 RingSize	 4000          # max# messages in outgoing circular msg buffer 
...
#                  send SCNL     map to SCNL
 ...
 #Send_scnl_remap JGR VHZ NC --   *   EHZ * *  # change component code only
  ...
  Send_scnl_remap * Ch1 BH   *     * HLZ BH * 
  Send_scnl_remap * Ch7 BH   *     * HHZ BH *
  Send_scnl_remap * Ch7 OBS  *     * HHZ OS *   
  Send_scnl_remap * Ch4 OBS  *     * HSZ OS *   
  Send_scnl_remap * Ch1 OBS  *     * HLZ OS *    
