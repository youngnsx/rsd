...
#
#
 MyModuleId     MOD_RINGDUP_SCN_BB  # module id for this program
 InRing         WAVE_RING           # transport ring to use for input
 OutRing        EXPPT_RING_BB       # transport ring to use for output
...
#              Installation       Module       Message Type
 ...
 MaxMsgSize     8192          # maximum size (bytes) for input/output msgs
 RingSize	4064          # max# messages in outgoing circular msg buffer 
...
#                  send SCNL     map to SCNL
 ...
 #Send_scnl_remap JGR VHZ NC --   *   EHZ * *  # change component code only
  ...
  Send_scnl_remap * Ch1  BB  *     * HLZ BB * 

  Send_scnl_remap * Ch7  BB  *     * HHZ BB *  
  Send_scnl_remap * Ch7 JPN  *     * HHZ JN *
  Send_scnl_remap * Ch7 FJ   *     * HHZ FJ *
  
  Send_scnl_remap * Ch7 BATS *     * HHZ BS *  
  Send_scnl_remap * Ch7 YMS  *     * HHZ YS *    
