...
# Ring   NAMED_EVENT_RING 2001    # this is a ring used for the tsunami ATWC programs for 
 ...
 Ring   WAVE_RING        1000    # public waveform data
 Ring   WAVE_RING_BB     1001
 Ring   WAVE_RING_BH     1002
 Ring   WAVE_RING_ST     1003
 Ring   PICK_RING        1005    # public parametric data
 Ring   WAVE_RING_CSMT   1015    # public hypocenters etc.

 Ring   EXPPT_RING       1030    # DST drink messages
 Ring   EXPPT_RING_BB    1031    # DST drink messages
 Ring   EXPPT_RING_BH    1032    # DST drink messages
 Ring   EXPPT_RING_ST    1033    # DST drink messages
 Ring   EXPPT_RING_SM    1034    # DST drink messages

 Ring   EEW_RING         1036    # private buffer for cubic_msg
 Ring   EEW_RING1        1037    # private buffer for cubic_msg
 Ring   TSMIP_RING       1098
 Ring   CWBSN_RING       1099
...
#--------------------------------------------------------------------------
 ...
 Module   MOD_RINGDUP_SCN_BB    152
 Module   MOD_RINGDUP_SCN_BH    153
 Module   MOD_RINGDUP_SCN_ST    154
 Module   MOD_RINGDUP_SCN_SM    171

 Module   MOD_PICK_EW_BB        155
 Module   MOD_PICK_EW_BH        156
 Module   MOD_PICK_EW_ST        157
 Module   MOD_PICK_EW_CSMT      158

 Module   MOD_IMPORT_ACK_OS     159
 Module   MOD_IMPORT_ACK_BB     160
 Module   MOD_IMPORT_ACK_BH     161
 Module   MOD_IMPORT_ACK_ST1    162
 Module   MOD_IMPORT_ACK_ST2    163
 Module   MOD_IMPORT_ACK_CSMT   164
 Module   MOD_PREP              165

 Module   MOD_PICK_EW_ST_P      168
 Module   MOD_TCPD_COMBINE      169
 Module   MOD_DCSN_TORING       170
